...
//Enviar 3 datos de una persona e imprimirlos
function imprimirPersona(nombre, edad, ciudad) {
  console.log("Nombre: " + nombre);
  console.log("Edad: " + edad);
  console.log("Ciudad: " + ciudad);
}
imprimirPersona("Carlos", 19, "Quito");

function registrarPersona(nombre, edad, ciudad) {
  for (const datos of [nombre, edad, ciudad]) {
    console.log(datos);
  }
}
registrarPersona("Carlos", 19, "Quito");
